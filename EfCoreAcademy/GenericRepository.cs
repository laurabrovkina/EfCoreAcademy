...
namespace EfCoreAcademy
{
    public class GenericRepository<T> : IGenericRepository<T> where T : BaseEntity
    {
        ...
        public async Task<List<T>> GetFilteredAsync(System.Linq.Expressions.Expression<Func<T, bool>>[] filters, int? skip, int? take, params System.Linq.Expressions.Expression<Func<T, object>>[] includes)
        {
            IQueryable<T> query = DbSet;
